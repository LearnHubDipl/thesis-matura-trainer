...
\caption{Zentrales Dashboard für den Gesamtfortschritt}
...
\item \textbf{Globaler Prüfungsdurchschnitt:} Dieses Widget fungiert als objektives Barometer. Es aggregiert alle bisherigen Leistungen und gibt eine realistische Einschätzung darüber ab, wie die aktuelle Leistung im Verhältnis zur angestrebten positiven Matura steht. Schwankungen werden geglättet, und ein stabiler Aufwärtstrend wird sofort erkennbar.
\end{itemize}
...
Durch diese gezielte Rückmeldung können Nutzer:innen ihre Lernsessions personalisieren. Wenn die Statistik beispielsweise zeigt, dass im Bereich „Stochastik“ noch 80% der Fragen offen sind, während „Geometrie“ bereits vollständig gefestigt ist, erlaubt dies eine sofortige Priorisierung. Die Plattform unterstützt somit ein selbstgesteuertes, ressourcenschonendes Lernen, bei dem die Energie exakt dort investiert wird, wo sie die größte Hebelwirkung für die finale Note erzielt. Zudem bietet die Oberfläche eine schnelle Auswahlmöglichkeit, um direkt aus der Statistik heraus in das Üben der unterrepräsentierten Themen einzusteigen.